...
| Proton | **Approved** (direct) + **Pending** (CJ) | Direct Proton Partners approval on 17 March 2026 at 19:06. Separately, CJ shows Proton Partners Program (advertiser 5227916) in Pending Applications as of 18 March 2026. These are two distinct commercial paths — reconcile before deploying tracking links. |
...
1. **Proton: reconcile the direct Proton Partners approval with the CJ pending application.** Determine which commercial path offers better terms, then log in to the chosen programme, get tracking links, and deploy across articles + `/tools` page. (Highest immediate leverage.)
