...
**Pinned to:** `main` @ `PENDING` **Last updated:** 27 March 2026 18:00 AEDT **Updated by:** Perplexity Computer (QA audit: affiliate tokens fixed, documentation synced, full verification pass)
...
| Latest deploy | `main` @ `PENDING` — READY |
